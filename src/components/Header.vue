    ...
    <div>
        <div class="bg-pattern md:pt-20 pb-32 pt-12">
            <div class="px-4 text-gray-200 text-center">
                ...
                <h1 class="font-bold text-5xl uppercase">Stand For Sudan</h1>
                <p class="mb-1 text-gray-200">Real time dashboard to track donations data</p>
                <p class="mb-6 text-gray-300">"Freedom, Peace, Justice" </p>
                <a href="https://github.com/Miaababikir/Stand-For-Sudan-Dashboard"
